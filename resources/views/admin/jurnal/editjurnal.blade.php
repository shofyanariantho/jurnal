        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <form action="/jurnal/{{$jurnal->id}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="row">
                                <div class="col-md-6 col-lg-8 pb-3">
                                    <div class="form-group">
                                        <label>Judul</label>
                                        <input type="text" value="{{$jurnal->judul}}" name="judul" class="form-control">
                                    </div>
                                    @error('judul')
                                    ...
                                    <div class="form-group">
                                        <label>Penulis</label>
                                        <input type="text" value="{{$jurnal->penulis}}" name="penulis" class="form-control">
                                    </div>
                                    @error('penulis')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                    <div class="form-group">
                                        <label>Abstrak</label>
                                        <textarea name="abstrak" class="form-control" rows="15">{{$jurnal->abstrak}}</textarea>
                                    </div>
                                    @error('abstrak')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-6 col-lg-4">	
                                    <div class="form-group">
                                        <label>Tahun</label>
                                        <input type="number" value="{{$jurnal->tahun}}" name="tahun" class="form-control">
                                    </div>
                                    @error('tahun')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                    <div class="form-group">
                                        ...
                                        <select name="kategori_jurnal_id" class="form-control">
                                            ...
                                            @foreach ($kategori as $item)
                                                @if ($item->id === $jurnal->kategori_jurnal_id)
